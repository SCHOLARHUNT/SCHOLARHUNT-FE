...
const Chat = (props: any) => {
  ...
  return (
    <div className="flex h-[600px] flex-1 flex-col">
      <div className="relative h-[600px] w-full transition-width flex flex-col overflow-hidden items-stretch flex-1">
        <div className="flex-1  overflow-hidden">
          <div className="h-[500px] w-full absolute top-0 overflow-y-scroll">
        ...
        <div className="absolute bottom-[-10px] left-0 w-full border-t md:border-t-0 dark:border-white/20 md:border-transparent md:dark:border-transparent md:bg-vert-light-gradient bg-white dark:bg-gray-800 md:!bg-transparent dark:md:bg-vert-dark-gradient pt-2">
          ...
          <div className="px-3 pt-2 pb-3 text-center text-xs text-black/50 dark:text-white/50 md:px-4 md:pt-3 md:pb-6">
            <span>Trợ lý ảo hỗ trợ tìm kiếm học bổng</span>
          </div>
        </div>
      </div>
    </div>
